...
3. **Gemini 3.5 Flash Causal Incident Forensics**: When a mandate is held, the **Forensics Agent** prompts **Gemini 3.5 Flash** to analyze the statistical deviation, identify affected components, and generate an executive-ready plain-English incident postmortem in Firestore.
